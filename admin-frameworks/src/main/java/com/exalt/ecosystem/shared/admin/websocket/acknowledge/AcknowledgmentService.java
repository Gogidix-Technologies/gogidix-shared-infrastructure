package com.exalt.ecosystem.shared.admin.websocket.acknowledge;
    ...
    public <T, R> R processWithAck(Message<T> message, MessageProcessor<T, R> processor) {
        ...
        if (messageId == null || messageId.isEmpty()) {
            ...
            try {
                ...
                logger.error("Error processing message without acknowledgment: " + e.getMessage(), e);
        ...
        try {
            ...
            try {
                ...
                logger.warn("Failed to send acknowledgment for message {}: {}", messageId, ackException.getMessage());
            }
            ...
            try {
                ...
                logger.warn("Failed to send error acknowledgment for message {}: {}", messageId, ackException.getMessage());
            }
            throw new RuntimeException("Error processing message", e);
        }
    }
