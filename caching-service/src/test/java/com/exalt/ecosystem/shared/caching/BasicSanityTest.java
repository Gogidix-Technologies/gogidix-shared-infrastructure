...
/**
 * Basic sanity tests for CachingService service
...
public class BasicSanityTest {
    ...
    public void applicationPropertiesTest() {
        ...
        String appName = System.getProperty("spring.application.name", "caching-service");
    ...
    public void serviceInitializationTest() {
        ...
        assertDoesNotThrow(() -> {
            ...
            String serviceName = "caching-service";
