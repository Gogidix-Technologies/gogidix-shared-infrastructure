...
User Profile Service is a core Java-based microservice in the Shared Infrastructure domain of the Social E-commerce Ecosystem. This service provides essential infrastructure capabilities that support the entire platform.
...
User Profile Service serves as a foundational component in the microservices architecture, providing critical infrastructure services that enable other domain services to function effectively.
...
DB_HOST=localhost
DB_PORT=5432
DB_NAME=user_profile_service_db
DB_USER=user_profile_service_user
...
cd shared-infrastructure/user-profile-service
```
